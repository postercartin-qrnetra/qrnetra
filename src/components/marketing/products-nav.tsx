...
const ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    description: "Cars, bikes, helmets, and parking tags",
  },
  {
    label: "Pets",
    href: "/products/pets",
    description: "Dog, cat, and general recovery tags",
  },
  {
    label: "Kids",
    href: "/products/kids",
    description: "School bags, tags, and wristbands",
  },
  {
    label: "Assets",
    href: "/products/assets",
    description: "Keys, wallets, luggage, and laptops",
  },
  {
